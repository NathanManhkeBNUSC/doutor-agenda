...
export const doctorsTable = pgTable("doctors", {
  ...
  avatarImagaUrl: text("avatar_image_url"),
  ...
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updaupdatedAt: timestamp("updated_at")
    .defaultNow()
    .$onUpdate(() => new Date()),
});
...
//Enum é um tipo de dado que define um conjunto de valores possíveis para uma coluna.
